...
Page({
    ...
    if (!token) {
      ...
      app.wxAPI.alert('未登陆!')
        .then(() => {
          ...
          if (this.data.hash){
            wx.reLaunch({
              url: `/pages/USER/user/user?from=pages/KILL/detail/detail&id=${this.data.goodsId}&hash=${this.data.hash}`
            })
  ...
  fxalert: function () {
    ...
    this.distributHash({ goods_id: this.data.goodsId})
  },
  gbplalert: function () {
    this.setData({
      fxalert: false,
 ...
 */
  onShareAppMessage: function (res) {
    ...
    return {
      title: "",
      path: '/pages/KILL/detail/detail?hash=' + that.data.hash + '&id=' + that.data.goodsId,
