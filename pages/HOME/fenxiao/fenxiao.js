...
Page({
  ...
  formSubmit: function (e) {
    ...
    if (e.detail.value.userName.length == 0 || e.detail.value.yhknum.length == 0 || parseInt(e.detail.value.money) == 0 || e.detail.value.yhkname.length == 0) {
      ...
      this.distributWd({ account_name: e.detail.value.userName, account_bank: e.detail.value.yhknum, bank_name: e.detail.value.yhkname, money: parseInt(e.detail.value.money) })
      this.setData({
        txalert: true
      })
    }
